...
Owned browser transport for the Hub Web bundle. It qualifies every remote session with its endpoint, selected workspace, and session identity and exposes the remote session operations used by Web UI packages.
